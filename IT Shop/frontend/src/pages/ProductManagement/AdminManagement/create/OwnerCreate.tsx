...
function OwnerCreate() {
    ...
    const onFinish = async (values: any) => {
        try {
            ...
            const result = await CreateOwnerWithImage(dataOwner, imageFile);
    
            if (result && result.owner) {
                messageApi.success('Owner and image saved successfully');
                form.resetFields(); // เคลียร์ฟิลด์ในฟอร์ม
                setImages([]); // เคลียร์ภาพที่อัปโหลด
            } else {
                messageApi.error('Failed to save owner or image');
            }
        } catch (error) {
                        ...
                        <div className="form-container">
                            ...
                            >
                                ...
                                <Form.Item
                                    ...
                                    style={{ flex: '0 0 48%' }}
                                >
                                    <Input placeholder="Enter AdminRole" />
                                </Form.Item>
